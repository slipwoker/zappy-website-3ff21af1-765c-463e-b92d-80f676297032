    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גורים קטנים למכירה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3ff21af1-765c-463e-b92d-80f676297032',
                    name: data.name || '',
                    email: data.email || '',
